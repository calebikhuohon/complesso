 ...
 docker build -t calebikhuohon/complesso-server:latest -t calebikhuohon/complesso-server:$GIT_SHA -f ./client/Dockerfile ./server
 docker build -t calebikhuohon/complesso-worker:latest -t calebikhuohon/complesso-worker:$GIT_SHA -f ./client/Dockerfile ./worker
